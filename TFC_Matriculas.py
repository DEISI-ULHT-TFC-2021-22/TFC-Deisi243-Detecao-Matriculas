...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\Diogo Pereira\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
class LicensePlateDetector:
    ...
    def read_plate(self):
        ...
        img = cv2.cvtColor(self.roi_image, cv2.COLOR_BGR2GRAY) 
        ...
        print(''.join(filter(str.isalnum, text)))
...
lpd = LicensePlateDetector(
    pth_weights='yolov3-train_last.weights', 
    pth_cfg='yolov3_testing.cfg', 
    pth_classes='classes.txt'
)

# Detect license plate
images_list = glob.glob('images/license-plates/*')
